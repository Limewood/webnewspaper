...
if($row['is_editor']) {
	...
	if(mysql_query("UPDATE ".$tableprefix."news SET reported_by='".$editor."' WHERE id='".$article."'")) {
		...
		$author = $row['name'];
		mysql_query("INSERT INTO ".$tableprefix."editors_log (editor, action, time, description) VALUES('".$editor."','reported an article',NOW(),'".$headline." with id ".$article." by ".$author."')");
